...
//         }
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if ("Person Login".equals(userType.getSelectedItem().toString())) {
            ...
            if (txtUsername.getText().matches("Sysadmin") && txtPassword.getText().matches("admin123")) {
            ...
            if (txtUsername.getText().matches("hospitaladmin") && txtPassword.getText().matches("hospital123")) {
...
//                patientManagerJButton.setEnabled(false);
            ...
            if ("Doctor".equals(userType.getSelectedItem().toString())){
             if (txtPassword.getText().matches("doctor123") && txtUsername.getText().matches("doctor")) {
